...
export function Logo() {
  return <Link href="/" className="brand" aria-label="KIM SILESIA — strona główna"><img src="https://raw.githubusercontent.com/KiMsilesia/home/main/archive/initial-project-brief/references/branding/logo-kim-silesia-approved.png" alt="KIM SILESIA" /></Link>;
}
